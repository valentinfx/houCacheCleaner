...
from houCacheCleaner.common import FILE_CACHE_NODE_TYPE_NAME, truncate


class Cache:
    """Object defining a cache and all its curent versions"""

    def __init__(self, name: str = None, version_paths: list[str] = None):
        """
    ...
    def set_versions(self, version_paths=None):
        ...
        self.versions = sorted(
            self.versions, key=lambda CacheVersion:CacheVersion.version_nbr, reverse=True)
    ...
    def get_last_three(self) -> tuple[CacheVersion]:
